...
SECRET_KEY = 'django-insecure-@7++_h90t)_$9+_4sc3%%!#_^e3#qf#(x^e_ql$ungb(g1k5=e'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

if not DEBUG:
    CSRF_TRUSTED_ORIGINS = [‘https://web-production-7494.up.railway.app 18’]
